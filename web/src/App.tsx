      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <article className="bg-white shadow-2xl shadow-red-500/35 max-w-4xl w-full mx-auto overflow-hidden">
          <div className="px-8 py-6 sm:p-12 lg:px-16 lg:py-10">
            ...
            <div className="mb-8 p-4 bg-gradient-to-r from-gray-50 to-gray-100 border border-gray-200 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-sm font-semibold text-gray-900">Live Implementation</h3>
                    <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                      Deployed
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 mb-3">
                    This website is deployed with all the concepts described in this blog post. The complete source code
                    and implementation details are available in the repository.
                  </p>
                  <a
                    href="https://github.com/dialohq/easybaremetal"
                    target='_blank'
